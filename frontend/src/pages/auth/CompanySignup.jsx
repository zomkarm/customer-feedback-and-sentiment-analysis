  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 shadow-lg rounded-lg w-full max-w-md">
        <h2 className="text-2xl font-semibold mb-6 text-center">Company Sign Up</h2>
        <form>
          <input type="text" placeholder="Company Name" className="w-full mb-4 p-2 border rounded" />
